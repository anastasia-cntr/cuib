...
const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      disabled={disabled}
      onClick={onClick}
      className={`disabled:opacity-50 disabled:cursor-not-allowed rounded-md w-full transition flex items-center justify-center hover:opacity-70 bg-rose-500 text-white
